...
| Scheduling | Shift templates, assignments, overrides, schedule views | Rotations, segments, publishable planning periods, multi-location planning | Planning periods and split segments are now supported; rotations remain missing | P1 | High | Extend shift model with rotation support | PARTIAL |
